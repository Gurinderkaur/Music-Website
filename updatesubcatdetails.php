...
//}
	...
	$scatid=$_GET["sscid"];
	$q="select * from subcategory where subcatid='$scatid'";
	...
	$cid=$_POST["co1"];
	$sname=$_POST["catname"];
    $err=$_FILES["userfile1"]["error"];
     if($err==0)
   {
	$date=date_create();
    $tstamp=date_timestamp_get($date);
    $spic=$tstamp.$_FILES["userfile1"]["name"];
    $tname=$_FILES["userfile1"]["tmp_name"];
   ...
   else
   {
	$spic=$y[3];  
     ...
     $conn=mysqli_connect(host,username,pass,dbname)or die("Error in connection".mysqli_connect_error());
    $q="update subcategory set Categoryid='$cid',subcatname='$sname',subcatpic='$spic' where subcatid='$scatid'";
     ...
     <!--contact-->
        <div class="contact">
	        <div class="container">
	          ...
	          <table width="883" border="0" align="center" cellpadding="0" cellspacing="5">
			    <tr>
			      <td colspan="2" align="center"><h1><strong><font color="#553A99">UPDATE MOVIE/ALBUM/SINGLE TRACK</h1></td>
		        </tr>
			    <tr>
			      <td>&nbsp;</td>
			      <td>&nbsp;</td>
	...
	else
	{
		while($x=mysqli_fetch_array($res))
		{
			...
			?>
			    ...
			    <tr>
			      <td width="429"><b>Movie/Album/Single Track Name</b></td>
			      <td width="439"><label>
			        <input type="text" name="catname" id="catname" value="<?php print $y[2];?>">
		          </label></td>
		        </tr>
			    <tr>
			      <td>&nbsp;</td>
			    ...
			    <tr>
			      <td><b>Movie/Album/Single Track Picture</b></td>
			      <td><br>
			        <?php
					print"<img src='uploads/$y[3]' height ='75'>";
					?>
			        </br>
                    <br>
