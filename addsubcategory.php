...
if(isset($_POST["submit"]))
{
     ...
     if($err==0)
   {
    ...
    $upic=$tstamp.$_FILES["subcatpic"]["name"];
   ...
   else
   {
	...
	$q="insert into subcategory(Categoryid,subcatname ,subcatpic)values('$cat','$subcatname','$upic')";
	...
	{
	$msg="Problem while adding subcategory,please try again";
	}
}
     ...
     <!--contact-->
        <div class="contact">
			...
			<table width="975" border="0" align="center" cellpadding="0" cellspacing="5">
		      <tr>
			      <td><h3><strong><font color="#553A99"><b>ADD MOVIE/ALBUM/SINGLE TRACK</b></font></strong></h3></td>
			      <td>&nbsp;</td>
		        </tr>
			    <tr>
			      <td>&nbsp;</td>
		      ...
		      <tr>
			      <td width="432">Choose Category</td>
			      <td width="528"><label>
...
?>	
			    ...
			    <tr>
			      <td>Add Movie /Album/Single Track Name</td>
			      <td><label>
			    ...
			    <tr>
			      <td>Movie /Album/Single Track Picture</td>
			      <td><label>
