...
<body>
	...
	$q="select * from addsong where artistid like '%$scidd%'";
	$res=mysqli_query($conn,$q) or die("Error in query" . mysqli_error($conn));
			...
			else
			{
				...
				while($x=mysqli_fetch_array($res))
				{
					...
					print"<td>
          <a href='showsongdetail1.php?siid=$x[1]'>
		  <img src='uploads/$x[6]' height='125' border='0'></a><br/>
					<a href='showsongdetail1.php?siid=$x[1]'>$x[4]</a>
					</td>";
					$count++;
