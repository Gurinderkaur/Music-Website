     ...
     if($cnt==0)
     {
	 ...
	 else
	  {
		      print"<table width='970' cellspacing='0'>
                ...
                <th><font color='#ffffff'><b>Artist picture</th> 
                 <th><font color='#ffffff'><b>Artist Name</th> 
		  ...
		  while($x=mysqli_fetch_array($res))
		  {
			  ...
			  $count++;
		        print"
				<td><img src='uploads/$x[2]' height='75' width='100'></td>
				<td>$x[1]</td>
				<td><a href='updateartdetails.php?aid=$x[0]'>Update</a></td>
			      <td><a href='delartist.php?aid=$x[0]'>Delete</a></td>
				</tr>";
		   }
		 print"</table>";
