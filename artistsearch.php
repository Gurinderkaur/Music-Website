...
<body>
	...
	<!--start-albums-->
     ...
     <!--contact-->
        <div class="contact">
	        <div class="container">
	          <h3 class="tittle">Artist Search </h3>
			<form name="form1" method="post" action="">
			  <table width="975" border="0" cellspacing="5" cellpadding="0">
			    <tr>
			      <td width="165">Enter Artist Name</td>
		...
		require_once("vars.php");
			...
			$q="select * from artistable where artistname like '%$aname%'";
	$res=mysqli_query($conn,$q) or die("Error in query" . mysqli_error($conn));
			...
			else
			{
				...
				while($x=mysqli_fetch_array($res))
				{
					...
					print"<td>
					<a href='showsong1.php?cid=$x[0]'>
						<img src='uploads/$x[2]' height='250' width='250' border='0'>
					</a><br/>
					<a href='showsong1.php?cid=$x[0]'>	
						$x[1]</a><br/>
