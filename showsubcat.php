     ...
     <!--contact-->
        <div class="contact">
          <table width="100%" border="0" align="center">
            <tr>
              <td align="center"><font color="#330099" size="7"><b>MOVIE/ALBUM/SINGLE TRACK</b></font></td>
            </tr>
          </table>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
		...
		$conn=mysqli_connect(host,username,pass,dbname) or die("Error in connection" . mysqli_connect_error());
		     $cid=$_GET["catid"];
			$q="select * from subcategory where categoryid like '%$cid%'";
	$res=mysqli_query($conn,$q) or die("Error in query" . mysqli_error($conn));
			...
			else
			{
				...
				while($x=mysqli_fetch_array($res))
				{
					...
					print"<td>
					<a href='showsong.php?scatid=$x[0]'>
		           <img src='uploads/$x[3]' height='125' width='150' border='0'>
					</a><br/>
					<a href='showsong.php?scatid=$x[0]'>	
						$x[2]</a><br/><br/>
					</td>";
